...
class Meta{
    ...
    constructor(){
        ...
        for(let library of libraries){
            ...
            if(is_file(path)){
                ...
                let updateTime = Updated.get(path) ;
        ...
        me.libraryUpdateTime = maxUpdateTime ;
    }
    ...
    externalHas(name){
        ...
        return me.#externalData.hasOwnProperty(name);
    }
    ...
    has(name){
        ...
        return me.#data.hasOwnProperty(name) || me.externalHas(name);
    }
